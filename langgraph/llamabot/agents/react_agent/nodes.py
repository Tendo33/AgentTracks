...
def write_html(html_code: str) -> str:
    ...
    """
    with open(
        "/Users/kodykendall/SoftEngineering/LLMPress/Simple/LlamaBotSimple/page.html",
        "w",
    ) as f:
        f.write(html_code)
...
def write_css(css_code: str) -> str:
    ...
    """
    with open(
        "/Users/kodykendall/SoftEngineering/LLMPress/Simple/LlamaBotSimple/assets/page.css",
        "w",
    ) as f:
        f.write(css_code)
...
def write_javascript(javascript_code: str) -> str:
    ...
    """
    with open(
        "/Users/kodykendall/SoftEngineering/LLMPress/Simple/LlamaBotSimple/assets/page.js",
        "w",
    ) as f:
...
def get_screenshot_and_html_content_using_playwright(url: str) -> tuple[str, list[str]]:
    ...
    """
    trimmed_html_content, image_sources = asyncio.run(
        capture_page_and_img_src(url, "assets/screenshot-of-page-to-clone.png")
    )
...
No extra markdown, no explanations, no leading or trailing whitespace outside the code block.
        ...
        """
            ...
            HumanMessage(
                content=f"Here is the trimmed down HTML: {trimmed_html_content}"
            ),
            HumanMessage(
                content=[
                    {
                        "type": "text",
                        "text": "Please clone this webpage based on the screenshot and HTML content provided.",
                    },
                    {
                        "type": "image_url",
...
sys_msg = SystemMessage(
    content="You are a helpful software_developer_assistant tasked with writing HTML, CSS, and JavaScript code to files. HTML is always written first, then CSS, then JavaScript. CSS will be written to assets/page.css and JavaScript will be written to assets/page.js, reference them accordingly in your generated code. If you are cloning a webpage, you will just write the final output directly into the single HTML page including the CSS and JavaScript in that single file."
)
